package com.xjl.app.process.login;
...
import com.xjl.app.process.login.bean.LoginInfo;
import com.xjl.app.process.login.bean.User;
import com.xjl.app.process.login.steps.LoginByPwdFragment;
import com.xjl.app.process.login.steps.LoginBySmsFragment;
